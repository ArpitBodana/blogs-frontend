  ...
  return (
    <div className="">
      <Head>
        ...
        <meta
          name="keywords"
          content="make difference ,Make Difference,Arpit Bodana"
        />
            ...
            <div key={blog.id} className="mb-4  relative">
              <Link href={`/blog/${blog.id}`}>
                <a>
                  ...
                  {blog.image && (
                    <div className="overflow-hidden relative  container text-center">
                      <Image
                        className=""
                        src={blog.image}
                        width={0.1}
...
export async function getServerSideProps() {
  const response = await axios.get(
    "https://chiku.pythonanywhere.com/blogs/read/"
  );
