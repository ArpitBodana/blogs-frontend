      ...
      <main>
        {bio.map((bio) => {
          return (
            <div
              key={bio.id}
              className="grid grid-cols-1  mb-4 relative  w-full"
            >
              <div>
                <p className="font-body text-lg md:text-2xl">{bio.aboutme}</p>
              </div>
              <h1 className="mt-3 font-time font-bold text-xl md:text-4xl relative  place-self-center">
                Hi, I'm <span className="text-red-500">Arpit Bodana</span>
              </h1>
              ...
              <div className="flex justify-center">
                <AlternateEmailIcon
                  color="success"
                  fontSize="large"
                  className="hover:shadow-xl hover:shadow-gray-600"
                />
              ...
              <div className="flex justify-center m-4 p-2 space-x-9">
                ...
                <a
                  href="https://www.linkedin.com/in/arpitbodana99/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <LinkedInIcon
